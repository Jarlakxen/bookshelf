...
@Entity
case class Project(name: String, description: String, @(Reference @field) properties: java.util.List[Property], @(Reference @field) modules: java.util.List[Module]) extends MongoModel[Project]{
